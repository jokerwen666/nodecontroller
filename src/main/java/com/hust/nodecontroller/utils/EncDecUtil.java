...
public class EncDecUtil {
    ...
    public static String sMEncrypt(String sourceData) throws Exception {
        return SM2EncDecUtils.encrypt(ConvertUtil.hexToByte(pubkSM), sourceData.getBytes());
    }
    ...
    public static String sMDecrypt(String encryptData) throws Exception {
        ...
        try {
            decrypt = new String(SM2EncDecUtils.decrypt(ConvertUtil.hexToByte(prikSM), ConvertUtil.hexToByte(encryptData)));
        } catch (Exception e) {
