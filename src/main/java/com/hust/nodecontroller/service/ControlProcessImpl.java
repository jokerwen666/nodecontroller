...
//        }
    ...
    public BulkInfo bulkRegister(JSONArray jsonArray, String dhtUrl, String bcUrl){
        ...
        StringBuilder bcretData = new StringBuilder();  //不确定bcFlag是否能转变为string
        String goodsHash,identity,url;
        Future<NormalMsg> bcFlag = null;
        ...
        do {
            ...
            identities.append(';');
            mappingData.append(url);
            mappingData.append(';');

            goodsHash=jsonObject.getString("goodsHash");
            bcFlag=blockchainModule.register(identity,goodsHash,url,bcUrl,"123456");
            bcretData.append(bcFlag);
            bcretData.append(';');
            number++;
        ...
        //bcretData=blockchainModule.register(identity,goodsHash,url,bcUrl,queryPermissions);
